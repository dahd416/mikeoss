                    ...
                    <div className="px-6 pt-3 pb-5 overflow-y-auto flex-1">
                        ...
                        {draft.format === "tag" && (
                            <div className="mt-3">
                                ...
                                <p className="mt-1 text-xs text-gray-400">Presiona Enter o coma para agregar una etiqueta.</p>
                            </div>
                        )}
                        ...
                        <textarea
                            ...
                            placeholder="Escribe el prompt de análisis — describe qué debe extraer Mike de cada documento para esta columna…"
