            ...
            <div className="w-full max-w-2xl rounded-2xl bg-white shadow-2xl flex flex-col h-[600px]">
                ...
                <div className="px-5 py-4 flex flex-col gap-4 flex-1 overflow-y-auto">
                    <EmailPillInput
                        ...
                        validate={async (email) =>
                            ownEmail && email === ownEmail
                                ? "No puedes compartir un flujo de trabajo contigo mismo."
                                : null
                        }
                    ...
                    <div className="flex flex-col gap-2">
                        <span className="text-xs font-medium text-gray-700">Permitir edición a los destinatarios</span>
                        <button
                            type="button"
                    ...
                    {/* Existing access */}
                    <div>
                        <p className="text-xs font-medium text-gray-700 mb-2">Personas con acceso</p>
                        {loading ? (
                                ...
                                {existingShares.map((share) => (
                                    <div key={share.id} className="flex items-center justify-between py-1">
                                        ...
                                        <div className="flex items-center gap-3 shrink-0">
                                            <span className="text-xs text-gray-400">{share.allow_edit ? "Puede editar" : "Solo lectura"}</span>
                                            <button
