...
export default function SupportPage() {
    ...
    const feedbackTypes: {
    ...
    }[] = [
        {
            ...
            description: "Reporta algo que no está funcionando",
        },
        {
            value: "feature",
        ...
        },
        {
            value: "question",
            label: "Pregunta",
            description: "Haz una pregunta sobre el uso de Mike",
        },
        {
            value: "other",
            label: "Otro",
            description: "Comentarios generales u otras consultas",
        },
    ];
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error("Error al enviar comentarios");
            }

            setIsSubmitted(true);
        } catch (err) {
            console.error("Error al enviar comentarios:", err);
            setError("Error al enviar tus comentarios. Por favor, inténtalo de nuevo.");
        } finally {
            ...
            <div className="h-full flex items-center justify-center p-4">
                <div className="max-w-md w-full bg-white rounded-xl text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                        Nos pondremos en contacto contigo pronto por correo
                        electrónico.
                    </p>
                    <button
                        onClick={() => router.push("/")}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {feedbackType === "bug" && (
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">
                                        Si el error está en un chat, pasa el
                                        mouse sobre el chat en la barra lateral,
                                        haz clic en los puntos, luego en
                                        compartir y pega el enlace aquí.
                                    </p>
                                </div>
                            )}
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Describe tu pregunta, problema o sugerencia en detalle..."
                                    rows={5}
