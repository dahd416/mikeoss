...
const TABS: { id: Tab; label: string }[] = [
    { id: "all", label: "Todos" },
    { id: "in-project", label: "En Proyecto" },
    { id: "standalone", label: "Independiente" },
];
...
export default function TabularReviewsPage() {
    ...
    const projectFilterButton = (
        <div className="relative" ref={filterRef}>
            ...
            >
                {selectedProject ? selectedProject.name                         : "Filtrar por proyecto"}
        ...
        <div className="flex-1 overflow-y-auto bg-white">
            ...
            <div className="mb-1 flex items-center justify-between px-4 py-3 md:px-10">
                ...
                <div className="flex items-center gap-2">
                    <HeaderSearchBtn value={search} onChange={setSearch} placeholder="Buscar revisiones…" />
                    <button
            ...
            <div className="w-full overflow-x-auto">
                ...
                <div className="flex items-center h-8 pr-3 md:pr-10 border-b border-gray-200 text-xs text-gray-500 font-medium select-none">
                    ...
                    <div className="ml-auto w-24 shrink-0">Columnas</div>
                    <div className="w-24 shrink-0">Documentos</div>
                    <div className="w-40 shrink-0">Proyecto</div>
                        ...
                        {activeTab === "all" && !projectFilter ? (
                            <>
                                ...
                                <p className="mt-1 text-xs text-gray-400 max-w-xs text-left">
                                    Extraer datos de documentos en tablas
                                    usando IA.
                                </p>
                                <button
                                    onClick={() => setNewTROpen(true)}
                                        ...
                                        <RowActions
                                            onRename={() => {
                                                if (
                                                    ...
                                                    setOwnerOnlyAction(
                                                        "renombrar esta revisión tabular",
                                                    );
                                                    return;
                                                }
                                                setRenameValue(
                                            ...
                                            onDelete={async () => {
                                                if (
                                                    ...
                                                    setOwnerOnlyAction(
                                                        "eliminar esta revisión tabular",
                                                    );
                                                    return;
                                                }
